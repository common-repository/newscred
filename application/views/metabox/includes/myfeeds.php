...
<?php foreach( $this->myfeeds as $article): ?>

    <li class="box-hover myfeeds-tooltip-from-element" data-tooltip-id="myfeeds-tooltip-example-<?php echo $index; ?>">
        ...
        <div class="contenthover">
            ...
            <a class="button nc-article-title-removed" id="nc-article-title-removed3-<?php echo $index; ?>" href="javascript:void(0);"><img width="11" height="11" src="<?php echo NC_IMAGES_URL."/remove.png";?>" /> Click to Remove</a>
            ...
            <div class="nc_hidden_image_sets">
                ...
                <ul class="image-set-thumbnail-box2<?php echo $index; ?> nc-image-sets">
                    <?php foreach($article->image_set as $image):?>
                    <li data-tooltip-id="myfeeds-tooltip<?php echo $index; ?>-thumbnail-<?php echo $imageindex; ?>" >
                        ...
                        <div id="myfeeds-tooltip<?php echo $index; ?>-thumbnail-<?php echo $imageindex; ?>" class="thumbnail-inner">
        ...
        <div id="myfeeds-tooltip-example-<?php echo $index; ?>" class="tipcontent">
            <div>
